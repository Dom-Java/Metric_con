package Metric;
//This is the package that I made to house my project.
...
class metric_main {
    ...
    //These are the Universal Variables used throughout all of my classes and Methods.
    ...
    public static void main(String[] args) {
        words(); //prints the title word "METRIC" and the instructions.
    ...
    //Title screen and instructions Method.
    static void words(){
    System.out.println("""
            
                    __              __     ______________        ________________________           __________            _____________________            ________________
                    ||\\            /||     ||___________|       |__________    __________|         |   _____  \\          |_____________________|          /   ____________|
                    || \\          / ||     ||                             |    |                   |  |     |  \\                 |     |                 /   /
                    ||  \\        /  ||     ||                             |    |                   |  |_____|   \\                |     |                /   /
                    ||   \\      /   ||     ||____________                 |    |                   |            /                |     |               |   |
                    ...
                    ||              ||     ||____________|                |____|                   |__|       \\_\\        |_____________________|         \\________________|            
            """);
    System.out.println("""
...
|                                                                                                                                                             |   |
|                                                                                                                                                             |   |
|   RULES: Below a menu will appear. You can choose from the initial input options of A, B, C, or E. Each initial option will provide you with a few          |   /                                                                                                                                              
|   Numerical options to determine which conversion rate that you would like to use. (Metric. Version 1.0)                                                   |  /                                                   
|                                                                                                                                                             | /
|_____________________________________________________________________________________________________________________________________________________________|/  
            """);
    }
